         ...
         <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 grid">
             ...
             <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
                 ...
                 <div class="flex items-center p-4 bg-white rounded-lg shadow-xs">
                     <div
                         class="flex items-center justify-center w-12 h-12 mr-4 bg-blue-100 text-blue-600 rounded-full text-xl">
                 ...
                 <div class="flex items-center p-4 bg-yellow-100 rounded-lg shadow-xs">
                     <div class="flex items-center justify-center w-12 h-12 mr-4 rounded-full text-yellow-600 text-xl"
                         style="background-color: #Fdffb8;">
                 ...
                 <div class="flex items-center p-4 bg-white rounded-lg shadow-xs">
                     <div
                         class="flex items-center justify-center w-12 h-12 mr-4 bg-green-100 text-green-600 rounded-full text-xl">
                 ...
                 <div class="flex items-center p-4 bg-white rounded-lg shadow-xs">
                     <div
                         class="flex items-center justify-center w-12 h-12 mr-4 bg-red-100 text-red-600 rounded-full text-xl">
                         ...
                         <tbody class="bg-white divide-y">
                             @foreach ($dataPengajuan as $pengajuan)
                                 <tr class="text-gray-700">
                                     ...
                                     <td class="px-4 py-3 text-sm">{{ $pengajuan->start_time }} - {{ $pengajuan->end_time }}
                                     </td>
