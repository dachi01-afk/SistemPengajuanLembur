          ...
          <ul>
            ...
            <li class="relative px-6 py-3">
              <a
                ...
                href="{{ url('apps/pegawai/pengajuan') }}"
              >
        ...
        <header class="z-10 py-4 bg-white shadow-md">
          ...
          >
            ...
            <ul class="flex items-center flex-shrink-0 space-x-6">
              ...
              <li class="relative">
                <button
                  class="align-middle rounded-full focus:outline-none focus:shadow-outline-purple"
                  @click="toggleProfileMenu"
                  @keydown.escape="closeProfileMenu"
                  aria-label="Account"
                  aria-haspopup="true"
                >
                  <img src="{{ asset('assets/img/profile.png') }}" class="object-cover w-8 h-8 rounded-full" alt="Profile">
