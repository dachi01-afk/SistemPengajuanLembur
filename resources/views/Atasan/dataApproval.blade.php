                     ...
                     <table id="dataTable" class="w-full whitespace-no-wrap">
                         <thead>
                             <tr
                                 ...
                                 <th class="px-4 py-3">Res Pegawai</th>
                         ...
                         <tbody class="bg-white divide-y">
                             @foreach ($requests as $request)
                                 <tr class="text-gray-700">
                                     ...
                                     <td class="px-4 py-3 text-sm">{{ $request->start_time }} - {{ $request->end_time }}
                                     </td>
                                     ...
                                     <td>
                                         <div class="flex items-center space-x-3">
                                             <button onclick="approveRequest({{ $request->id }})"
                                                 class="approve-btn text-purple-600 hover:text-purple-800 focus:outline-none">
                                                 <i class="fas fa-check-circle text-xl"></i>
                                             </button>
                                             <button onclick="rejectRequest({{ $request->id }})"
                                                 class="reject-btn text-purple-600 hover:text-purple-800 focus:outline-none">
